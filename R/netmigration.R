...
# data must be a demogdata object containing population values for the last year of observation
# mort and mig are fmforecast2 objects and fert is a fmforecast object. 
# If they are NULL, it is assumed all values are zero.
